 ...
 * Useful for lightweight API key / admin token scenarios.
 * New entries are merged; existing keys are overwritten.
 */
...
/**
 * Remove all extra headers previously set via setExtraHeaders.
 */
...
export async function customFetch<T = unknown>(
  ...
  // Attach any extra headers (e.g. x-admin-token) registered via setExtraHeaders.
