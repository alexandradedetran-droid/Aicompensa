  ...
  try {
    const rows = await db
      .select({
        ...
        imagemResolvidaUrl: folhetoImportItemsTable.imagemResolvidaUrl,
        origemImagem: folhetoImportItemsTable.origemImagem,
        imagemMatchScore: folhetoImportItemsTable.imagemMatchScore,
        imagemRevisaoPendente: folhetoImportItemsTable.imagemRevisaoPendente,
        imagemSugeridaUrl: folhetoImportItemsTable.imagemSugeridaUrl,
        imagemSugeridaOrigem: folhetoImportItemsTable.imagemSugeridaOrigem,
        imagemResolucaoMeta: folhetoImportItemsTable.imagemResolucaoMeta,
